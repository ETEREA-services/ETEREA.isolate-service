...
# El pom.xml define <finalName>eterea.isolate-service</finalName>
COPY --from=build /app/target/eterea.isolate-service.jar ./eterea.isolate-service.jar

# Cambiamos al usuario no privilegiado
USER appuser

# Comando para ejecutar la aplicación
ENTRYPOINT ["java", "-jar", "eterea.isolate-service.jar"]
